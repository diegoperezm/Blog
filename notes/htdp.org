...
*** 3.4 From Functions to Programs
    :PROPERTIES:
    :CUSTOM_ID: from-functions-to-programs 
    :END: 
...
*** 3.6 Designing World Programs
    :PROPERTIES:
    :CUSTOM_ID: designing-world-programs
    :END: 
...
*** 4 Intervals, Enumerations, and Itemizations
    :PROPERTIES:
    :CUSTOM_ID: intervals-enumerations-and-itemizations 
    :END: 
...
*** 4.1 Programming with Conditionals
    :PROPERTIES:
    :CUSTOM_ID: programming-with-conditionals 
    :END: 
...
- The simplest interval has two boundaries:
    a. left
    b. right
...
1.- First, it immediately suggests how to pick examples:
    Clearly we want the function to work inside of all the intervals, and we want the function to work properly at the ends of each interval
...
If we wanted to make this choice obvious and immediate for every reader of our code,
...
- You have two choices to fix repetition:
    ...
    2. use cond expression as:
       An expression that may appear anywhere in a function, including in the middle of some other expression
#+END_QUOTE

*** 4.5 Itemizations 
    :PROPERTIES:
    :CUSTOM_ID: itemization  
    :END: 
...
*** 4.6 Designing with Itemizations
    :PROPERTIES:
    :CUSTOM_ID: designing-with-itemizations
    :END: 
...
- Luxury items:
    With a price of more than $10,000, are taxed at the rate of eight percent (8.00%).
...
#+BEGIN_QUOTE
_Design a function for a cash register that ,given the price of an item, computes the sales tax:_
...
- 10000 and above:          10000, and 12017.
 ...
 Instead of just writing down the expected result,
 we write down how to compute the expected result.
